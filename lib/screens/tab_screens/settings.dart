...
import 'package:testing/model/notifiers/userData_notifier.dart';
import 'package:testing/model/services/auth_service.dart';
import 'package:testing/model/services/pushNotification_service.dart';
import 'package:testing/model/services/user_management.dart';
import 'package:testing/screens/settings_screens/cards.dart';
import 'package:testing/screens/settings_screens/editProfile.dart';
import 'package:testing/screens/settings_screens/passwordSecurity.dart';
import 'package:testing/utils/colors.dart';
import 'package:testing/utils/internetConnectivity.dart';
import 'package:testing/widgets/allWidgets.dart';
import 'package:testing/widgets/provider.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: Future.wait([profileFuture!, addressFuture]),
      builder: (c, s) {
                      ...
                      Center(
                        child: GestureDetector(
                          ...
                          child: Padding(
                            ...
                            //           child: Image.asset(
                            //             "assets/images/testing-footprint-logo-whiteBg.png",
                            //             height: 90.0,
                            //             width: 90.0,
                            //           ),
                            //         )
                            ...
                            //             height: 90.0,
                            //             width: 90.0,
                            //             placeholder: "assets/images/testing-footprint-logo-whiteBg.png",
                            //           ),
                            //         ),
                            // ),
                          ),
