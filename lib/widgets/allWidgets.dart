...
import 'package:testing/model/notifiers/cart_notifier.dart';
import 'package:testing/model/services/Product_service.dart';
import 'package:testing/screens/tab_screens/homeScreen_pages/productDetailsScreen.dart';
...
Widget primaryTextField(
  ...
  //  autovalidate: autoValidate,
    ...
    decoration: InputDecoration(
      ...
      labelText: labelText,
      labelStyle: normalFont(MColors.appBarDark, 14.0),
...
//       subject: 'Hi!',
//       text:
//           'Hi, I use Pet Shop to care for my pets fast and easy, Download it here at https://github.com/thenifemi/testing and for every download, a dog gets a treat.',
//       mimeType: 'text/plain');
// }
//-------------------------------------------
      ...
      children: <Widget>[
        Row(
          ...
          children: <Widget>[
            Text(
              "Processing",
              style: normalFont(
                  processing ? Colors.green : Color(0xffbdbdbd), 12.0),
            ),
            SizedBox(width: 35.0),
            Text(
              "confirmed",
              style:
                  normalFont(confirmed ? Colors.green : Color(0xffbdbdbd), 12.0),
            ),
            SizedBox(width: 35.0),
            Text(
              "En Route",
              style:
                  normalFont(enRoute ? Colors.green : Color(0xffbdbdbd), 12.0),
            ),
            SizedBox(width: 35.0),
            Text(
              "Delivered",
              style:
                  normalFont(delivered ? Colors.green : Color(0xffbdbdbd), 12.0),
            ),
          ],
        ),
        SizedBox(height: 5.0),
        Row(
          ...
          children: <Widget>[
            //PROCESSING
            checkPoint(
              processing ? Colors.green : Color(0xffbdbdbd),
              Center(
            ...
            bar(confirmed ? Colors.green : Color(0xffbdbdbd)),

            SizedBox(width: 5.0),

            //CONFIRMED
            checkPoint(
              confirmed ? Colors.green : Color(0xffbdbdbd),
              Center(
            ...
            bar(enRoute ? Colors.green : Color(0xffbdbdbd)),

            SizedBox(width: 5.0),

            //EN ROUTE
            checkPoint(
              enRoute ? Colors.green : Color(0xffbdbdbd),
              Center(
            ...
            bar(delivered ? Colors.green : Color(0xffbdbdbd)),

            SizedBox(width: 5.0),

            //DELIVERED
            checkPoint(
              delivered ? Colors.green : Color(0xffbdbdbd),
              Center(
        ...
        builder: (context) {
          return CupertinoAlertDialog(
            content: Text(
              ...
              style: normalFont(MColors.textDark, 12),
            ),
            actions: <Widget>[
              CupertinoDialogAction(
                child: Text(
                  "Cancel",
                  style: normalFont(Colors.red, 12),
                ),
                onPressed: () async {
              ...
              CupertinoDialogAction(
                ...
                child: Text(
                  "Yes",
                  style: normalFont(Colors.blue, 12),
                ),
                onPressed: () {
                  getCart(cartNotifier);
