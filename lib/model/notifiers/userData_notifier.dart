...
class UserDataProfileNotifier with ChangeNotifier {
  late List<UserDataProfile> _userDataProfileList = [];
  late UserDataProfile _userDataProfile;
...
class UserDataAddressNotifier with ChangeNotifier {
  ...
  late UserDataAddress _userDataAddress;
...
class UserDataCardNotifier with ChangeNotifier {
  ...
  late UserDataCard _userDataCard;
