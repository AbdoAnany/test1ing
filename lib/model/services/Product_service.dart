...
import 'package:testing/model/data/cart.dart';
import 'package:testing/model/data/orders.dart';
...
import 'package:testing/model/notifiers/orders_notifier.dart';
...
// addProdProducts( ) async {
//   food.forEach((key, value) async{
//     await FirebaseFirestore.instance.collection("food").doc(key).set(value);
//   });
//   print('done');
//
// }
